...
**なぜこの形にしたかは [docs/design.md](docs/design.md) にあります。**
全体を貫く判断が 4 つあり、それぞれが**どのコードに現れているか**を表で追えます
——受信と解釈を分ける理由も、生 JSON を捨てない理由も、あちらが正本です。

以下の 2 節は、図に描いた 2 本の経路のうち、**読む前に知っておくと図の意味が変わる**ものです。
